...
Hooks:PostHook( WeaponFactoryTweakData, "init", "Type56Init", function(self)
...
local vanilla_t56sight = deep_clone(all_t56sight)
--- Barrel Extensions --
local all_t56ext = {
	...
	"wpn_fps_ass_ak_chicom_762_md_t56"
}
local all_t56fl = {
...
for id, st_id in pairs (all_ar15stock) do
	self.wpn_fps_ass_ak_chicom_762.override[st_id] = {depends_on = "stock_adapter"}
	self.wpn_fps_ass_ak_chicom_762.override[st_id] = {a_obj = "a_s_ar15"}
end

--=========================--
--        	ADDS           --
--=========================--
self.parts.wpn_fps_ass_ak_chicom_762_dc_no.forbids = self.parts.wpn_fps_ass_ak_chicom_762_dc_no.forbids or {} -- STFU PAYDAY
--- Gun ---
for id, o_id in pairs(all_t56sight) do
	self.wpn_fps_ass_ak_chicom_762.adds[o_id] = {"wpn_fps_ass_ak_chicom_762_om_tula"}
	table.insert(self.parts.wpn_fps_ass_ak_chicom_762_dc_no.forbids, o_id)
end

-- for id, md_id in pairs(all_t56ext) do
	-- self.parts.wpn_fps_ass_ak_chicom_762_ba_ak104.override[md_id] = {a_obj="a_ns_ak104"}
-- end
...
--- Vanilla sights ---
for id, o_id in pairs(vanilla_t56sight) do
	if self.parts[o_id].stance_mod.wpn_fps_ass_flint then
		self.parts[o_id].stance_mod.wpn_fps_ass_ak_chicom_762 = deep_clone(self.parts[o_id].stance_mod.wpn_fps_ass_flint)
	else
